...
> = {
  candidate: {
    ...
    sub: "Aarya is built for job seekers in India. Tell it what you want in text or voice — it reads your CV, finds live India-eligible roles, scores your fit, and requests warm intros on your behalf.",
    checks: ["Aarya for candidates", "India-first", "Free to start"],
