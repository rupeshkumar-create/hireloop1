...
- [x] **Step 2: Run the test and verify it fails because `ai_operations` does not exist**
...
- [x] **Step 4: Add integration assertions for invalid transitions and active idempotency**
...
- [x] **Step 2: Run the unit tests and verify import/behavior failures**
...
- [x] **Step 4: Implement service functions**
...
- [x] **Step 6: Run unit tests and Ruff**
...
- [x] **Step 2: Verify the routes return 404 before registration**

Run: `cd api && uv run pytest tests/test_ai_operation_routes.py -v`  
Expected: FAIL with route 404s.

- [x] **Step 3: Implement and register the router**
...
- [x] **Step 4: Add cross-user integration tests**
...
- [x] **Step 5: Run route and IDOR tests**
...
- [x] **Step 4: Add a progress helper for handlers**
...
- [x] **Step 5: Add database integration coverage**
...
- [x] **Step 1: Write failing route tests for `202` responses**
...
- [x] **Step 2: Verify current synchronous responses fail the new contract**

Run: `cd api && uv run pytest tests/test_career_path.py -k operation -v`  
Expected: FAIL because both routes await generation.

- [x] **Step 3: Add `CAREER_PATH_GENERATE` and `CAREER_INTELLIGENCE_GENERATE` handlers**
...
- [x] **Step 4: Convert submission routes**
...
- [x] **Step 5: Run focused tests and the production timing contract**
...
- [x] **Step 1: Add failing contract tests for each submission route**
...
- [x] **Step 2: Verify the tests fail because routes return feature-specific processing shapes**

Run the focused route suites and record the expected response mismatches.

- [x] **Step 3: Replace direct `enqueue_job` calls with `enqueue_ai_operation`**
...
- [x] **Step 4: Publish meaningful handler progress**
...
- [x] **Step 5: Run all affected backend suites**
...
- [x] **Step 1: Add Vitest and write failing schema/polling tests**
...
- [x] **Step 2: Implement shared components and mount the provider**
...
- [x] **Step 3: Update API clients for immediate-or-operation unions**
...
- [x] **Step 4: Integrate all scoped feature entry points**
...
- [x] **Step 1: Write failing error-classification tests**
...
- [x] **Step 2: Implement boundary-accurate errors**
...
- [x] **Step 3: Audit remaining synchronous external-AI calls**
...
- [x] **Step 1: Run the complete backend verification**
...
- [x] **Step 3: Run dependency and secret audits**
...
- [x] **Step 4: Dry-run the production migration**
...
- [x] **Step 8: Update phase tracking and commit**
