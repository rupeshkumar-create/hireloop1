...
export const BLOG_POSTS: BlogPost[] = [
  {
    ...
    body: [
      ...
      "Hireschema's intro flow keeps the candidate in control: you approve the draft, Aarya handles the research, and the hiring manager sees a human connection, not spam.",
